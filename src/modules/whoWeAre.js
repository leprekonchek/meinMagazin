function textFor() {
    ...
    ($(`<p>Поэтому спускайтесь в киевское метро, включайте свой любимый плейлист и направляйтесь на станцию метро "Контрактовая". На углу Спасской вы найдете нашу оффлайн точку, а по пути сможете загялнуть в Espresso Holic, лучшие чизкейки во всём Киеве продаются именно там.</p>`)).appendTo('#weare');
    ($(`<p><a href="https://www.instagram.com/sima.ufo/">(my insta here)</a></p>`)).appendTo('#weare');
    return $text;
}
